...
export default function ServicesPage() {
  return (
    <main>
      ...
      <footer><div className="wrap footer-grid"><div className="footer-col"><div className="logo">{/* eslint-disable-next-line @next/next/no-img-element */}<img src="/images/gifted-delites-logo.jpg" alt="Gifted Delites" /></div><p>Spreading joy and goodwill through memorable corporate gifts.</p></div><div className="footer-col"><h4>Explore</h4><a href="/about">About</a><a href="/services">Our Services</a><a href="/products">Product Catalogs</a></div><div className="footer-col"><h4>Start an Enquiry</h4><a href="https://wa.me/2349126105778" target="_blank" rel="noreferrer">WhatsApp</a><a href="/#contact">Contact</a></div></div><div className="wrap footer-bottom">© {new Date().getFullYear()} Gifted Delites. All rights reserved.</div></footer>
    </main>
  );
}
